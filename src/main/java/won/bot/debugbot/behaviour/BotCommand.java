...
public class BotCommand {
    ...
    public BotCommand(String commandSyntax, String infoMessage, Pattern pattern, BiConsumer<Connection, Matcher> action) {
    ...
    public void execute(Connection con, Matcher matcher) {
        if(this.action != null) {
            ...
            throw new UnsupportedOperationException("BotCommand is non executable, no BiConsumer action set");
        }
    }
